	...
	return (
		<main data-aos="fade-up" className="container">
			<div className="my-20">
				...
				<p className="text-center text-[#585858] md:text-xl text-lg font-semibold mt-5">
					Growth becomes a breeze when paired with proper preparation and
					experience. Our team and our <br /> partners are on hand to assist
				...
				<div className="grid gap-10 my-20 md:grid-cols-4">
					<div className="text-center shadow-lg bg-white p-2">
						<img
							...
							alt=""
						/>
						<h2 className="text-[#1f2559] my-2 text-xl font-bold">
							Direct Rep Support
						</h2>
						<p className="text-[#757998]">
							We have direct communication with the official representatives of
					...
					<div className="text-center shadow-lg bg-white p-2">
						...
						<p className="text-[#757998]">
							Enjoy an auction advantage with proper account structuring and
					...
					<div className="text-center shadow-lg bg-white p-2">
						...
						<p className="text-[#757998]">
							Our clients don’t waste time with warmup periods or spending
					...
					<div className="text-center shadow-lg bg-white p-2">
						...
						<p className="text-[#757998]">
							If your business operates in a restricted niche, we can help you
					...
					<div className="text-center shadow-lg bg-white p-2">
						...
						<p className="text-[#757998]">
							Never miss out on points or cashback again. You can use your
					...
					<div className="text-center shadow-lg bg-white p-2">
						...
						<p className="text-[#757998]">
							We assist with restricted assets to ensure that you can keep
					...
					<div className="text-center shadow-lg bg-white p-2">
						...
						<p className="text-[#757998]">
							Follow our account structuring guides to help protect your assets
					...
					<div className="text-center shadow-lg bg-white p-2">
						...
						<p className="text-[#757998]">
							We are the only agency with a self-service app. Manage ad
							accounts, top-ups and more from any device.
						</p>
					</div>
				</div>
